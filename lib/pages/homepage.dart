          ...
          children: <Widget>[
                          ...
                          child: CircleAvatar(
                            ...
                            child: Transform.rotate(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  NavigatorUtils.pushPage(Search(), context, Curves.easeIn, 1000, Alignment.topRight);
                                },
                              ),
                            ),
                          ),
              ...
              child: Column(
                children: <Widget>[
                  Padding(
                    ...
                    child: _buildHeaders("Upcoming", width, height,_movieModel.resultUpcoming)
                  ),
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: <Widget>[
                  _buildHeaders("Now Playing", width*1.01, height,_movieModel.resultNowPlaying),
                  Padding(
        ...
        Tween<double>(begin: 0, end: 250).animate(_sidebarController)
          ..addStatusListener((listener) {
            if (listener == AnimationStatus.completed) {
              ...
              _colorController.forward().orCancel;
              Future.delayed(Duration(milliseconds: 250), () {
                print("Future Opacity Listener tetiklendi");
                _opacityController.forward().orCancel;
              });
            } else {
    ...
    _animation = Tween<double>(begin: 0, end: pi).animate(_animationController)
      ..addStatusListener((listener) {
        if (listener == AnimationStatus.completed) {
          ...
          _sidebarController.forward().orCancel;
        } else if (listener == AnimationStatus.reverse) {
          _sidebarController.reverse().orCancel;
        }
      });
  }
                            ...
                            children: <Widget>[
                                ...
                                child: FadeInDown(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: CachedNetworkImage(
                                      height: height*0.2,
                                      width: width*0.18,
                                      imageUrl: _userModel.user.profilePhotoURL,
                              ...
                              Padding(
                                ...
                                child: FadeInDown(
                                  ...
                                  child: Text(
                                    _userModel.user.email.substring(0,_userModel.user.email.indexOf("@")),
                                    style: GoogleFonts.robotoSlab(
                                      color: Colors.white,
                                      fontSize: 22,
                                      fontStyle: FontStyle.italic,
  ...
  _buildBelowFilms(BuildContext context,double height,double width) {
    ...
    ListView.builder(
        itemBuilder: (context, index) {
          ...
          return InkWell(
            onTap: () async=> await _getMoviePage(movies.id), //Navigator.push(context, MaterialPageRoute(builder: (context)=>MovieDetail(movies))),
            child: Padding(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        Text(
                          movies.title.length>50 ? movies.title.substring(0,30)+"..." : movies.title,
                        ...
                        Text(
                          "${movies.releaseDate.year}-${movies.releaseDate.month}-${movies.releaseDate.day} ",
                          style: GoogleFonts.abhayaLibre(
                              fontSize: 17,
                              color: Colors.white,
                              shadows: [
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              InkWell(
                onTap: () => NavigatorUtils.pushPage(MovieList(header: header,movies: movies), context, Curves.easeIn, 1000, Alignment.center),
                child: Container(
                  decoration: BoxDecoration(
